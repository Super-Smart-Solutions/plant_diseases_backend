...
from planet_diseases_backend.db.models.crop import Crop


class CropDAO(BaseDAO[Crop]):
    """
    Data Access Object (DAO) for managing Crop entities in the database.

    This class inherits from the `BaseDAO` class and provides specific methods
    for interacting with Crop data.
